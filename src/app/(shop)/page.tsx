...
export default function ShopHome() {
  ...
  const openModal = (product: Product) => {
    // Bloqueia clique se estoque for 0
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
        ...
        selectedOptions: selectedOptions // Passa opções para o carrinho para baixar estoque depois
    }, quantity);
  ...
  return (
    <div className="space-y-8 pb-24">
              ...
              {items.map((product) => {
                ...
                return (
                  <div 
                      ...
                      className={`bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex gap-3 transition-colors group relative overflow-hidden ${isOutOfStock ? 'opacity-60 grayscale cursor-not-allowed' : 'cursor-pointer hover:border-pink-300'}`}
                  >
                    {/* Tarja de Esgotado */}
                    {isOutOfStock && (
                        <div className="absolute inset-0 z-10 flex items-center justify-center bg-gray-100/50">
                            <span className="bg-gray-800 text-white text-xs font-bold px-3 py-1 rounded uppercase">Esgotado</span>
                        </div>
                    )}
      ...
      {/* MODAL (Só abre se tiver selectedProduct) */}
      {selectedProduct && (
                        ...
                        <div key={group.id} className="bg-gray-50 p-3 rounded-lg border">
                            ...
                            <div className="space-y-2">
                                {group.options.map(opt => {
                                    ...
                                    // Bloqueio visual para opção sem estoque
