...
export default function CartPage() {
  ...
  const [newAddr, setNewAddr] = useState<Partial<UserAddress>>({ regionType: 'plano_diretor', street: "", number: "", district: "", complement: "", nickname: "Casa", cep: "" });
    ...
    <div className="pb-40 pt-2 px-4 max-w-2xl mx-auto">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border mb-24">
            ...
            <div className="grid grid-cols-2 gap-2">
                ...
                {storeSettings?.paymentMethods.link_debit.active && (<button onClick={() => setPaymentMethod('link_debit')} className={`py-3 px-2 border rounded-lg text-xs font-bold ${paymentMethod === 'link_debit' ? 'bg-blue-50 border-blue-500 text-blue-700' : ''}`}><LinkIcon size={18}/> Débito</button>)}
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t p-4 shadow-lg safe-area-bottom z-40">
            <div className="max-w-2xl mx-auto space-y-3">
                ...
                {/* BOTÃO DE CHECKOUT (BLOQUEADO SE FECHADO) */}
                <button 
        ...
        {/* MODAL ENDEREÇO (INTEGRADO IGUAL ANTERIOR) */}
        {isAddrModalOpen && (
