    ...
    <div className="pb-40 pt-2 px-4 max-w-2xl mx-auto">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border mb-24">
            ...
            <div className="grid grid-cols-2 gap-2">
                ...
                {storeSettings?.paymentMethods.money.active && (<button onClick={() => setPaymentMethod('money')} className={`py-3 px-2 border rounded-lg text-xs font-bold ${paymentMethod === 'money' ? 'bg-green-50 border-green-600 text-green-800' : ''}`}><Banknote size={18}/> Dinheiro</button>)}
